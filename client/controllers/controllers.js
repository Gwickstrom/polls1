app.controller('usersController', ['$scope', '$cookies', '$location', 'userFactory', function($scope, $cookies, $location, userFactory){
...
app.controller('pollsController', ['$scope', '$cookies', '$routeParams', '$location', 'pollFactory', function($scope, $cookies, $routeParams, $location, pollFactory){
    ...
    $scope.addPoll = function(){
        console.log($scope.newPoll, "in app");
